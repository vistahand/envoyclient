...
const RecipientModal = ({ onClose, shipmentData, onUpdate }) => {
  ...
  const getInitialValues = () => {
    ...
    if (shipmentData?.recipient) {
      ...
      initialValues.fullNameRec = recipient.name;
      initialValues.phoneRec = recipient.phone;
      initialValues.mailRec = recipient.email;
      initialValues.altPhoneRec = recipient.alternatePhone;
      initialValues.countryRec = recipient.address.country;
      initialValues.address1Rec = recipient.address.line1;
      initialValues.address2Rec = recipient.address.line2;
      initialValues.areaRec = recipient.address.area;
      initialValues.townRec = recipient.address.city;
      initialValues.stateRec = recipient.address.state;
      initialValues.postalRec = recipient.address.postalCode;
      initialValues.vatRec = recipient.vatId;
    }
                    ...
                    <div className="grid md:grid-cols-4 grid-cols-2 md:gap-5 ss:gap-5 gap-4 w-full">
                      <div className="relative flex flex-col col-span-2">
                        <input
                          ...
                          ${
                            formik.touched.fullNameRec &&
                            formik.errors.fullNameRec
                              ? "outline-mainRed"
                              : "outline-main6"
                          }
                          `}
                      ...
                      <div className="relative flex flex-col col-span-2">
                        <input
                          ...
                          bg-transparent w-full focus:outline-primary
                          ${
                            formik.touched.altPhoneRec &&
                            formik.errors.altPhoneRec
                              ? "outline-mainRed"
                              : "outline-main6"
                          }
                          `}
                      ...
                      <div className="relative flex flex-col col-span-2">
                        <div className="relative flex items-center">
                          {formik.values.countryRec && (
                            <img
                              src={
                                countries.find(
                                  (country) =>
                                    country.cca2 === formik.values.countryRec
                                )?.flags?.png
                              }
                              alt="flag"
                          ...
                          <select
                            ...
                            ${
                              formik.touched.countryRec &&
                              formik.errors.countryRec
                                ? "outline-mainRed"
                                : "outline-main6"
                            }`}
                          >
                        ...
                        >
                          You cannot change the country/region of recipient
                          unless you cancel shipment.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <div className="relative flex flex-col col-span-2">
                        <input
                          ...
                          bg-transparent w-full focus:outline-primary
                          ${
                            formik.touched.address1Rec &&
                            formik.errors.address1Rec
                              ? "outline-mainRed"
                              : "outline-main6"
                          }
                          `}
                      ...
                      <div className="relative flex flex-col col-span-2">
                        <input
                          ...
                          bg-transparent w-full focus:outline-primary
                          ${
                            formik.touched.address2Rec &&
                            formik.errors.address2Rec
                              ? "outline-mainRed"
                              : "outline-main6"
                          }
                          `}
