...
const Hands = () => {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (
        desktopTrackContainerRef.current &&
        !desktopTrackContainerRef.current.contains(event.target)
      ) {
  ...
  return (
    <section
      className="w-full md:min-h-[300px] ss:min-h-[300px] 
    ...
    >
      ...
      >
        ...
        >
          <h1
            className="text-primary font-semibold md:text-[40px]
          ...
          <p
            className="text-main md:text-[16px] ss:text-[15px] 
                    text-[14px] md:max-w-[700px] ss:max-w-[400px]  
                    md:leading-[1.3rem] ss:leading-[1.2rem] leading-[1.2rem] 
                    font-medium tracking-tight"
          >
            We pride ourselves in the satisfaction of the numerous businesses,
            families and individuals that trust us to provide the safest
            ...
            className={`text-[13px] rounded-full py-3 px-6 flex 
                        ...
                        ${
                          isDesktopExpanded
                            ...
                            : "bg-secondary text-white grow4 cursor-pointer gap-3 justify-center"
                        }`}
            ...
            <div
              onClick={(e) => {
                ...
                if (desktopTrackingNumber.trim()) {
                  window.location.href = `/trackshipment?tracking=${desktopTrackingNumber.trim()}`;
            ...
            <div
              onClick={(e) => {
                ...
                if (mobileTrackingNumber.trim()) {
                  window.location.href = `/trackshipment?tracking=${mobileTrackingNumber.trim()}`;
