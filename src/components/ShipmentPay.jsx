            ...
            <div className="w-full">
              <div className="flex flex-col w-full items-center gap-4">
                <button
                  ...
                  onClick={handlePay}
                  disabled={loading}
                  className={`bg-primary text-[13px] py-3.5 px-14 flex text-white 
                  rounded-full cursor-pointer items-center justify-center gap-3 w-full md:w-auto
                ...
                <button
                  ...
                  disabled={loading}
                  className={`text-primary text-[13px] py-3.5 px-14 flex border border-primary
                  rounded-full cursor-pointer items-center justify-center gap-3 w-full md:w-auto
                  ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
                >
                  {loading ? (
