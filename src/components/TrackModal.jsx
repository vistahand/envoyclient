        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className="md:w-[50%] ss:w-[50%] w-full flex flex-col 
              ...
              >
                ...
                md:mt-24 bg-primary1 rounded-full"
                >
                  <GrLocation
                    className="md:w-[5rem] ss:w-[4rem] w-[4.5rem] h-auto
                ...
                >
                  ...
                  >
                    <h1
                      className="text-primary font-bold md:text-[35px]
                    ...
                    <h2
                      className="md:text-[17px] ss:text-[17px] text-[14px]  
                    tracking-tight font-medium text-main2 md:leading-[22px]
                    ss:leading-[22px] leading-[20px] trackmodmob"
                    >
                      Enter your shipment tracking ID to see where your package
                      is and where it's been in real time.
                    </h2>

                    <div
                      className="text-[13px] rounded-full md:py-3 py-3.5 px-5 
