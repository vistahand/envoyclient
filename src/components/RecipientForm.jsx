...
const RecipientForm = ({ onNext, onPrev, selectedTab, senderTab }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      mailRec: "",
      altPhoneRec: "",
      countryRec: shipmentData?.destination?.country || "NG", // Pre-fill from destination country
      address1Rec: "",
      address2Rec: "",
      areaRec: "",
      townRec: "",
  ...
  useEffect(() => {
    if (shipmentData?.destination?.country) {
      formik.setFieldValue("countryRec", shipmentData.destination.country);
    }
  }, [shipmentData]);
                ...
                <div className="relative flex flex-col col-span-2">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.phoneRec &&
                                      formik.errors.phoneRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
                ...
                <div className="relative flex flex-col col-span-2">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.mailRec &&
                                      formik.errors.mailRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
                ...
                <div className="relative flex flex-col col-span-2">
                  ...
                  <p className="text-main2 font-medium md:text-[12px] ss:text-[12px] text-[11px] tracking-tight">
                    {currentTab === "international"
                      ? "For international shipments, recipient's country is fixed based on your initial selection."
                      : "For local shipments, recipient's country is fixed based on your initial selection."}
                  </p>
                </div>
              </div>
                ...
                <div className="relative flex flex-col">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.areaRec &&
                                      formik.errors.areaRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
                ...
                <div className="relative flex flex-col">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.townRec &&
                                      formik.errors.townRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
                ...
                <div className="relative flex flex-col">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.postalRec &&
                                      formik.errors.postalRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
                ...
                <div className="relative flex flex-col">
                  <input
                    ...
                    className={`md:py-3.5 py-3 md:px-3.5 px-3 
                                    ...
                                    bg-transparent w-full focus:outline-primary
                                    ${
                                      formik.touched.vatRec &&
                                      formik.errors.vatRec
                                        ? "outline-mainRed"
                                        : "outline-main6"
                                    }
                                    `}
