    ...
    const fetchShipmentDetails = async () => {
      try {
        ...
        if (trackingToUse) {
          ...
          // First check if we have this shipment in localStorage
          const storedShipment = getShipmentByTracking(trackingToUse);

          // Then fetch fresh data from API
          const response = await shipments.getByTrackingId(trackingToUse);

          if (response.success) {
            // Combine stored data with fresh API data, prioritizing API data
            setShipmentData({
              ...storedShipment,
            ...
            if (storedShipment) {
              // Use stored data if API failed
              setShipmentData(storedShipment);
            } else {
              throw new Error("Could not retrieve shipment data");
            }
          }
        } else {
          ...
          <div className="flex flex-col gap-5 w-full">
            ...
            <div className="w-full">
              <p className="md:text-[16px] ss:text-[16px] text-[15px] tracking-tight font-medium text-main2 leading-[23px]">
                ...
                <span className="font-extrabold">Dublin Dispatch Station</span>{" "}
                on{" "}
                <span className="font-extrabold">
                  {shipmentData?.lastUpdate?.date ||
                    "Wednesday 30th October, 2024"}{" "}
                </span>
                and is currently on its way to{" "}
                <span className="font-extrabold">
                  {shipmentData?.destination?.hub || "Lagos Sorting Hub"}.
                </span>
              </p>
            </div>
          ...
          <div className="w-full md:mt-6 ss:mt-6 mt-4 gap-5 rounded-xl p-5 border-main7 border flex flex-col">
            ...
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="flex gap-4 items-center">
                <div className="md:w-[4.5rem] w-[4rem] h-auto bg-primary1 rounded-full">
              ...
              {/* Connector line */}
              <div className="md:h-[3rem] ss:h-[3rem] h-[2rem] w-[2px] bg-primary md:ml-[2.2rem] ss:ml-[2rem] ml-[1.95rem]" />

              {/* Additional status sections similar to above */}
              {/* Package Dropped off */}
              <div className="flex gap-4 items-center">
                <div className="md:w-[4.5rem] w-[4rem] h-auto bg-primary1 rounded-full">
                  <TbCircleCheckFilled className="md:w-[4.5rem] w-[4rem] h-auto text-primary md:p-4 p-3" />
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="flex items-center gap-3.5">
                    <p className="font-medium md:text-[14px] ss:text-[14px] text-[13px] tracking-tight text-main4">
                      ...
                      <span className="md:hidden ss:hidden">, 11:03AM</span>
                    </p>
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <div className="flex items-center gap-3.5">
                    <p className="font-medium md:text-[14px] ss:text-[14px] text-[13px] tracking-tight text-main4">
                      Wednesday 30th October, 2024
                      <span className="md:hidden ss:hidden">, 04:48PM</span>
                    </p>

                    <div className="h-[3px] w-[3px] bg-main4 hidden md:flex ss:flex" />
              ...
              {/* Shipment Arrival (Estimated) */}
              <div className="flex gap-4 items-center">
                <div className="md:w-[4.5rem] w-[4rem] md:h-[4.5rem] h-[4rem] bg-mainalt rounded-full items-center justify-center flex">
