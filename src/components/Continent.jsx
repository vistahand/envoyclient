...
const Continent = () => {
    ...
    return (
        ...
        min-h-[900px] flex items-center">
            ...
            relative md:pb-6 ss:pb-6 pb-4 justify-between">
                <motion.div variants={fadeIn('right', 'spring', 0.3)}
                className="md:w-1/2 ss:w-1/2">
                    <img src={globe} 
                        alt='globe'
                ...
                items-start md:w-1/2 ss:w-1/2'>
                    ...
                    md:leading-[1.4rem] ss:leading-[1.4rem] leading-[1.3rem] 
                    tracking-tight'>
                    ...
                    <div className="w-full flex flex-col gap-3 pb-1">
