                ...
                <>
                  <div
                    className="w-full flex md:flex-row ss:flex-row flex-col 
                                  ...
                                  md:py-12 ss:py-10 py-6 md:justify-between ss:justify-between"
                  >
                    {/* Sender Country Currency Section */}
                    <div className="w-full flex items-start gap-3">
                      ...
                      <div className="flex flex-col gap-y-3">
                        <div className="flex gap-2 items-center">
                          <img
                            src={
                              countries.find((country) => country.cca2 === paymentDetails.shipment?.sender?.address?.country)
                                ?.flags?.png
                            }
                            alt="flag"
                        ...
                        >
                          {formatCurrency(
                            paymentDetails.shipment?.cost?.baseAmount || 0, 
                            paymentDetails.shipment?.cost?.currency || 'ngn'
                          )}
                        </h1>
                      </div>
                    </div>
...
=======
                    {/* Recipient Country Currency Section */}
                    <div className="w-full flex items-start gap-3">
                      <div className="flex md:gap-3 gap-5 w-full items-center">
                        <div
                          className="md:w-[5rem] ss:w-[4rem] w-[4.5rem] h-auto 
                      ...
                      <div className="flex flex-col gap-y-3">
                        <div className="flex gap-2 items-center">
                          <img
                            src={
                              countries.find((country) => country.cca2 === paymentDetails.shipment?.recipient?.address?.country)
                                ?.flags?.png
                            }
                            alt="flag"
                            className="w-8 h-[1.2rem] rounded-[0.2rem]"
                        ...
                        >
                          {formatCurrency(
                            paymentDetails.shipment?.cost?.total || 0, 
                            paymentDetails.shipment?.cost?.currency || 'eur'
                          )}
                        </h1>
                      </div>
                    </div>
