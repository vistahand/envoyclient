...
const ImageCard = ({ image }) => {
  return (
    <div className="ss:w-[500px] w-[330px] ss:h-[210px] h-[170px]">
      <img src={image} alt="heroImage" className="rounded-2xl w-full" />
    </div>
  );
};
...
const Hero = () => {
  ...
  return (
    <section
      className="relative w-full md:min-h-[500px] ss:min-h-[500px] 
    ...
    >
      <div className="relative items-center w-full max-w-[68rem] flex">
        <div
          className="md:items-center ss:items-center w-full flex 
        ...
        >
          ...
          >
            <h1
              className="text-primary font-[700] md:text-[57px]
            ...
            >
              ...
              and seamless deliveries across borders
            </h1>

            <p
              className="text-main font-[500] md:text-[17px] 
            ...
            >
              With Envoy Angel, your shipments are in safe hands. From quick and
              easy bookings to 24/7 tracking, we're here to ensure a smooth
              logistics experience for every shipment, big or small.
            </p>
          </motion.div>
      ...
      >
        ...
        <div
          className="absolute md:top-[55%] ss:top-[55%] top-[45%] 
