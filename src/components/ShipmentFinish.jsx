...
const ShipmentFinish = () => {
  ...
  useEffect(() => {
    // Extract tracking from query params
          ...
          <div className="md:w-[50%] w-full flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-5 w-full">
              ...
              >
                ...
                >
                  Transaction ID:{" "}
                  <span className="font-bold">TRX-18084578123</span>
                </p>
              ...
              <div className="flex flex-col md:gap-6 ss:gap-6 gap-5">
                ...
                >
                  ...
                  <span className="font-bold">
                    {" "}
                    You will receive an email notification once your payment is
                    confirmed and your shipment is processed.
                  </span>
                </p>
