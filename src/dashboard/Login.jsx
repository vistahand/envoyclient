...
const Login = () => {
  ...
  return (
    <section className='relative w-full flex md:items-center md:min-h-auto font-manrope
          ...
          gap-5'>
            ...
            gap-5">
              <div className='flex flex-col gap-1 w-full'>
                ...
                Don't have an account? <br className="hidden
                  ss:flex"/>
                  <a href='/register' className='text-primary font-bold 
                  hover:text-secondary navsmooth'> Create an account here</a>
                </h2>
              </div>
                    ...
                    <div className="relative flex flex-col">
                      <div className="relative">
                        <input
                          ...
                          md:text-[14px] ss:text-[14px] text-[12px] outline-[1px]
                          bg-transparent w-full focus:outline-primary
                          ${formik.touched.password && formik.errors.password ? 'outline-mainRed' : 'outline-main6'}
                          `}
                        />
