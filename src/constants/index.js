...
export const cards = [
  {
    ...
    description:
      "Get updates in real time for every drop-off point your shipment package arrives at, completely keeping you in the loop.",
  },
  {
    image: LuPackage,
    title: "Safe and secure packaging",
    description:
      "Be rest assured that your shipments are properly boxed and safely packaged to withstand whatever.",
  },
  {
    image: TbHeadset,
    title: "24/7 Customer support service",
    description:
      "Our dedicated customer care team is ready to attend to your complaints swiftly and effectively.",
  },
];
...
export const moveCards = [
  {
    ...
    description:
      "Generate an instant quote for any package by creating an account and following the easy steps to get you started.",
  },
  {
    image: movecard2,
    title: "Track your package",
    description:
      "Go with your package everywhere! Log in to your account to follow your package at every drop-off easily and seamlessly.",
  },
  {
    image: movecard3,
    title: "It's time for delivery!",
    description:
      "Whether you're a customer or client waiting to receive your goods or a business sending out shipments, safe deliveries are assured.",
  },
];
...
export const blogCards = [
  {
    image: blog1,
    title:
      "Navigating International Shipping: Top Tips for First-Time Shippers",
    description:
      "If you're new to shipping across borders, this guide is perfect for you. We cover everything from choosing the right shipping method to understanding customs regulations. Avoid common mistakes and ensure your first shipment goes smoothly, whether you're sending goods to Ireland, Nigeria, or anywhere else in the world.",
  },
  {
    image: blog2,
    title: "How Real-Time Tracking is Revolutionizing the Shipping Industry",
    description:
      "GPS-enabled tracking is changing the way businesses and individuals approach shipping. In this article, we explore how real-time tracking enhances transparency, improves customer satisfaction, and reduces lost or delayed shipments. See why staying informed about your shipment's journey is now a must for modern logistics.",
  },
  {
    image: blog3,
    title: "The Ultimate Guide to Shipping Between Ireland and Nigeria",
    description:
      "Whether you're sending personal items or commercial goods, this guide gives you the complete rundown on shipping between Ireland and Nigeria. Learn about customs regulations, required documentation, shipping routes, and tips for ensuring your package moves quickly and smoothly through the process. Perfect for both first-timers and seasoned shippers looking for a refresher.",
  },
];
...
export const shipmentSteps = [
  {
    ...
    description:
      "Tell us about your shipment. Enter the dimensions, weight, and type of package.",
  },
  {
    image: fileinvoice,
    title: "Get an instant Quote",
    description:
      "Once you've provided your shipment information, get an instant quote tailored to your needs.",
  },
  {
    image: mapsearch,
    title: "Select Pickup Location",
    description:
      "Choose your pickup point from our wide network of locations across Ireland and Nigeria.",
  },
  {
    image: cash,
    title: "Choose Payment & Confirm",
    description:
      "Select your preferred payment method. After payment, you'll receive a receipt in your dashboard.",
  },
];
...
export const nextSteps = [
  {
    ...
    description:
      "Our team is currently cross-checking your payment details with our bank records. This may take a short while.",
    // link: "Change pickup location",
    // route: '/createshipment-payment'
  },
  {
    ...
    description:
      "Once your payment is verified, you'll receive a confirmation email with your shipment details and tracking ID.",
    // link: "Track my shipment",
    // route: '/createshipment-payment'
  },
  {
    ...
    description:
      "Get a better experience by creating an account. View past shipments, track deliveries, and manage future bookings seamlessly.",
  ...
  },
  {
    title: "Still need help?",
    description:
      "If you have questions, our support team is ready to assist. Connect via Live Chat or email us at support@envoyangel.com.",
    link: "Contact Us",
    route: "/contact",
  },
];
